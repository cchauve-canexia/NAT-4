...
Variants with a VAF below 1% or with an alternate coverage < 100 reads or a
...
The results are in the directory `VAF_1`.

The set of all called indels is in the file `ALL_SAMPLES_predicted_VAF_1.vcf`.
